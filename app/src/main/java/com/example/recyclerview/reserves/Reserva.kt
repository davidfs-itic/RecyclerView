...
class ReservesProvider{
    companion object {
        val Reserves:List<Reserva> = listOf(
            ...
            Reserva(1,2,"2023-02-01".toDate("yyyy-MM-DD"),"2023-01-15".toDate("yyyy-MM-DD"),"Reserva 2"),
            Reserva(1,2,"2023-03-01".toDate("yyyy-MM-DD"),null,"Reserva 3"),
            Reserva(1,2,"2023-04-01".toDate("yyyy-MM-DD"),null,"Reserva 4"),
        )
    }
}